...
const PersonalDetails = forwardRef(
  ({ formData, setFormData, setError }, ref) => {
        ...
        <div className="inputs">
          ...
          <div className="input-fields side-by-side">
            <div className="input-field">
              ...
              <input
                ...
                value={formData.personalDetails.fathersOccupation}
                onChange={handleChange}
            ...
            <div className="input-field">
              ...
              <input
                type="text"
                id="fathersmobileNumber"
                value={formData.personalDetails.fathersmobileNumber}
                onChange={handleChange}
          ...
          <div className="input-fields side-by-side">
            <div className="input-field">
              ...
              <input
                ...
                value={formData.personalDetails.mothersOccupation}
                onChange={handleChange}
            ...
            <div className="input-field">
              ...
              <input
                ...
                value={formData.personalDetails.mothersmobileNumber}
                onChange={handleChange}
                placeholder="Enter Mobile Number"
              />
            </div>
          ...
          <div className="input-field">
            ...
            <input
              type="text"
              id="corrAddr"
              value={formData.personalDetails.corrAddr}
              onChange={handleChange}
          ...
          <div className="input-field">
            ...
            <input
              type="text"
              id="perAddr"
              value={formData.personalDetails.perAddr}
              onChange={handleChange}
          ...
          <div className="input-fields side-by-side">
            ...
            <div className="input-field">
              ...
              <input
                type="text"
                id="mothersTongue"
                value={formData.personalDetails.mothersTongue}
                onChange={handleChange}
