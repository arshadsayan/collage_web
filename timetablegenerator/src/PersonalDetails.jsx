...
<div className="input-field">
      ...
      <div className="input-fields side-by-side">
        ...
        <div className="input-field">
          <label htmlFor="fathersmobileNumber">Father's Mobile Number:</label>
      ...
      <div className="input-fields side-by-side">
        ...
        <div className="input-field">
          <label htmlFor="mothersmobileNumber">Mother's Mobile Number:</label>
      ...
      <div className="input-fields side-by-side">
        ...
        <div className="input-field">
          ...
          <input type="text" id="annualIncome" value={formData.personalDetails.annualIncome} onChange={handleChange} placeholder="Enter annual income" />
        </div>
      </div>
  ...
  <option value="O-">O-</option>
      ...
      <div className="input-field">
        <label htmlFor="corrAddr">Correspondence address:</label>
  ...
  <select id="state" className="dropdown-field" value={formData.personalDetails.state} onChange={handleChange}>
    ...
    <option value="Puducherry">Puducherry</option>
      ...
      <div className="input-field">
        <label htmlFor="perAddr">Permanent address:</label>
  ...
  <option value="Zimbabwean">Zimbabwean</option>
      ...
      <div className="input-fields side-by-side">
        ...
        <div className="input-field">
          <label htmlFor="mothersTongue">Mother tongue:</label>
