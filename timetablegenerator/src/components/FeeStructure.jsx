...
function FeeStructure() {
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/feeStructure')
      .then((response) => {
  ...
  const handleUpload = async() => {
    ...
    try {
      const response = await axios.post("http://localhost:3001/fee-structure-upload", feeData);
      console.log("Data uploaded successfully:", response.data);
      // Fetch the updated data after successful upload
      const updatedResponse = await axios.get('http://localhost:3001/feeStructure');
  ...
  const handleUpdate = async() => {
    ...
    console.log("Uploading data:", feeData);
    try {
      const response = await axios.put("http://localhost:3001/fee-structure-update", feeData);
