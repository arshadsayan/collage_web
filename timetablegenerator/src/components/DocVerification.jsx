...
function DocVerification() {
  ...
  const handlePreview = (filename) => {
    const fileUrl = `http://localhost:3001/files/${filename}`;
        ...
        <div className="row verify-row1">
          ...
          <div className="col-9 verify-col2">
            ...
            <div className="row verify-row2">
              ...
              <div className="col">
                <b>JEE seatnumber</b> : ADSA12133
              </div>
              <div className="col">
                <b>CET seatnumber</b> : BCK123129
              </div>
            </div>
            <div className="row verify-row2">
              <div className="col">
              ...
              <div className="row">
                ...
                <div className="col ">
                  <button
                    ...
                    onClick={() =>
                      handlePreview(
                        "aryaait121@gst.sies.edu.in/1718387815132-KOMAL%20GHADIGAONKAR.pdf"
                      )
                    }
                  >
                    Preview
                ...
                <div className="col">
                  <div className="row btn-row">
                    ...
                    }} class="btn btn-success arbtn">
                      Approve
                    </button>
                    <button type="button" onClick={()=>{
                      setRejectDropdown(true);
                    }} class="btn btn-danger arbtn">
                      Reject
                    </button>
                  </div>
                </div>
              </div>
              {rejectDropdown === row.id && (
                <div className="row">
