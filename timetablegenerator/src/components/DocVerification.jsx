...
function DocVerification(selectedStudent) {
  ...
  return (
    <>
      <div className="title">
        <div className="row">
          <div className="col-2">
            <button button type="button" onClick={handleBackClick} class="btn backbtn">Back</button>
          </div>
        ...
        <div className="row verify-row1">
          ...
          <div className="col-9 verify-col2">
            <div className="row verify-row2">
              <div className="col"><b>Name</b> : {selectedStudent.name}</div>
