  ...
  return (
    <>
      ...
      <div className="search-container">
        <div className="row">
          <div className="col-1">
            <div className="col-1 search-bar-icon "> Search</div>
          </div>
          <div className="col-10">
            <div className="row ">
              <div className="row ">
                <div className="col-6 row1col1 admission-type">
                  <div className="row">
                    <div className="col">Admission Type </div>
                    <div className="col">
                ...
                <div className="col-6 row1col1">
                  <div className="row">
                    <div className="col">Select Class</div>
                    <div className="col">
                      <div className="dropdown dropdown-btn admissionSelectButton">
                        <div className="dropdown">
                          <button
            ...
            <div className="row ">
              <div className="row ">
                <div className="col-6 row1col1 admission-type">
                  <div className="row">
                    <div className="col">Documents Approved</div>
                    <div className="col">
                      <div className="dropdown dropdown-btn admissionSelectButton">
                        <div className="dropdown">
                          <button
                ...
                <div className="col-6 row1col1">
                  <div className="row">
                    <div className="col">Transaction approved</div>
                    <div className="col">
                      <div className="dropdown dropdown-btn admissionSelectButton">
                        <div className="dropdown">
                          <button
